...
test("shogi.or.jp 20241167", async () => {
  const pageUrl = "https://www.shogi.or.jp/tsume_shogi/everyday/20241167.html";
  const expectedKifUrl =
    "https://www.shogi.or.jp/tsume_shogi/data/everyday_20241106.kif";
  expect(await PageUrlToKifUrl(pageUrl)).toStrictEqual(ok(expectedKifUrl));
});

test("shogi.or.jp 20241097", async () => {
  const pageUrl = "https://www.shogi.or.jp/tsume_shogi/everyday/20241097.html";
  const expectedKifUrl =
    "https://www.shogi.or.jp/tsume_shogi/data/everyday_20241009.kif";
  expect(await PageUrlToKifUrl(pageUrl)).toStrictEqual(ok(expectedKifUrl));
});

test("shogi.or.jp 20231117", async () => {
  const pageUrl = "https://www.shogi.or.jp/tsume_shogi/everyday/20231117.html";
  const expectedKifUrl =
    "https://www.shogi.or.jp/tsume_shogi/data/everyday_20230111.kif";
  expect(await PageUrlToKifUrl(pageUrl)).toStrictEqual(ok(expectedKifUrl));
});

test("shogi.or.jp 20231119", async () => {
  const pageUrl = "https://www.shogi.or.jp/tsume_shogi/everyday/20231119.html";
  const expectedKifUrl =
